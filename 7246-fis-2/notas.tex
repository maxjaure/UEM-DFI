...
que ele ncontrou estava próximo do valor atualmente aceito, que é
...
partícula atuaram duas forças gravitacionais devido às duas partículas
...
\begin{ex}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[width=0.45\textwidth,keepaspectratio]{potencial_espira.pdf}
...
\begin{ex}
  ...
  o centro da fita e a partícula é $z-R\cos\theta$. Mostre que a
  energia potencial gravitacional da partícula é dada por
  $$V_g=-\int_0^{\pi}\frac{2\pi Gm\sigma R^2\sin\theta}{\sqrt{R^2\sen^2\theta+(z-\cos\theta)^2}}\,d\theta\,.$$
  \begin{figure}[ht]
    \centering
    \includegraphics[width=0.45\textwidth,keepaspectratio]{potencial_esfera.pdf}
