...
lado, as funções cosseno e seno tem período $2\pi$, ou seja, o menor
valor de $p$ tal que $\cos(z+p)=\cos z$ e $\sen(z+p)=\sen z$ para
qualquer $z$ é $p=2\pi$. Logo, segue da Eq.~(\ref{eq:19}) que, para
qualquer $t$,
\begin{equation*}
  \begin{split}
