...
\begin{ex}
  ...
  $$v=\sqrt{\frac{GM_T}{r}}\,.$$
  Definindo o \textbf{período da órbita}, $T$, como o tempo que a
  partícula demora em dar uma volta na órbita, mostre que
...
Antes de Newton formular a lei da gravitação Universal, Kepler,
baseado em observações dos planetas, obteve as seguintes leis
empíricas:
\begin{enumerate}
\item Os planetas se movem em órbitas elípticas ao redor do Sol, o
  qual está localizado em um dos focos da elipse.
